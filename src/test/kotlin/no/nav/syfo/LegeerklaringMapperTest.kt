...
internal class LegeerklaringMapperTest {
    ...
    internal fun `Tester mapping fra fellesformat til Legeerklaring format`() {
        ...
        assertEquals(null, legeerklaering.plan?.behandling?.dato)
        ...
        assertEquals(true, legeerklaering.forslagTilTiltak.kjopAvHelsetjenester)
        ...
        assertEquals("Andre opplysninger", legeerklaering.kontakt.kontakteAnnenInstans)
