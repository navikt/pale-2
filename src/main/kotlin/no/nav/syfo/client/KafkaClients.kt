...
class KafkaClients(env: Environment, credentials: VaultSecrets) {
    ...
    init {
        ...
        producerPropertiesString[ProducerConfig.COMPRESSION_TYPE_CONFIG] = "snappy"
        ...
        producerPropertiesString[ProducerConfig.MAX_REQUEST_SIZE_CONFIG] = 5.times(1024).times(1000).toString()
    }
